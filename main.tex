...
\begin{frame}{Registration}
  ...
  \vspace{-0.4cm}
    ...
    \begin{figure}[ht]
    \centering
    \includegraphics<1>[width=0.9\textwidth]{fig/metric_1}%
    \includegraphics<2>[width=0.9\textwidth]{fig/metric_3}%
    \includegraphics<3>[width=0.9\textwidth]{fig/metric_7}%
    \includegraphics<4>[width=0.9\textwidth]{fig/metric_18}
    \label{fig:metric_1}
  \end{figure}
...
\begin{frame}{Conclusion}
  ...
  \footnotetext{\url{https://github.com/fgrelard/Esmraldi}}
