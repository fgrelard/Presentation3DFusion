...
\date{10 février 2020} % set the Date
...
\begin{frame}{Chaîne de traitement 3D : rappels}
  ...
  \visible<2-> {
    ...
    \begin{figure}[ht]
      ...
      \includegraphics<4>[width=0.7\textwidth]{fig/normalization_sic1}%
      \includegraphics<5>[width=0.7\textwidth]{fig/normalization_sic2}%
      \includegraphics<6>[width=0.7\textwidth]{fig/normalization_sic3}%
      \caption{}
